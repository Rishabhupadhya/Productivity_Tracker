...
export default function Sidebar({ collapsed = false }: { collapsed?: boolean }) {
  ...
  useEffect(() => {
    if (location.pathname === "/finance") {
      ...
      if (active === "Finance" || active === "Goals" || active === "Habits") {
        setActive("My Work");
      }
    }
  }, [location.pathname]);
      ...
      <aside className="sidebar" style={{ width: collapsed ? "60px" : "250px", overflow: collapsed ? "hidden" : "auto" }}>
        ...
        {collapsed ? (
          <>
            ...
            <div style={{ borderTop: "1px solid #333", margin: "8px 0" }}></div>
            <a className={active === "Finance" ? "active" : ""} onClick={() => { setActive("Finance"); navigate("/finance"); }} title="Finance Tracker">💰</a>
          ...
          <div style={{ color: "#666", fontSize: "12px", padding: "8px 16px" }}>
            ...
            <a
              ...
              onClick={() => {
                setActive("Finance");
                navigate("/finance");
                window.dispatchEvent(new CustomEvent('viewChanged', { detail: { view: 'Finance' } }));
              }}
            >
              💰 Finance Tracker
            </a>
